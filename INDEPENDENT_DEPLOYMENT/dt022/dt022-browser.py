...
try:
    ...
    wait.until(lambda d:'/work' in d.current_url and ticket in d.page_source and 'Operational attention:' in d.page_source)
    ...
    wait.until(EC.presence_of_element_located((By.CSS_SELECTOR,f'section[data-ticket-id="{ticket}"]')))
    wait_loaded(ticket)
    ...
    wait_loaded('One current Responsible Role is in force')
