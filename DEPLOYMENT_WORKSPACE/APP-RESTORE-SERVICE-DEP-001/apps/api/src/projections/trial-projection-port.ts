...
async function readWorkQueue(pool: Pool): Promise<unknown> {
...
async function readIntake(pool: Pool, subjectRef?: string): Promise<unknown> {
...
export function createTrialProjectionPort(pool: Pool): UiProjectionPort {
  return Object.freeze({
