...
export function ResponsibilityHandoverView(){
  ...
  const d=projection?.data;const current=record(d?.["current_responsibility"]);const proposals=list(d?.["handover_proposals"]);const runtime=list(d?.["runtime_handover_context"]);const c=(projection?.currentness_ref??"MISSING_BINDING") as Currentness;
